 ...
 * Created by xueli.
 */
public class UtryWalkingRouteSearchActivity extends AppCompatActivity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  AIUIPlugin.Companion.getInstance().(false);
//        FloatVoicePlugin.getInstance().message.observe(this, new Observer<String>() {
//            @Override
...
//        });
    ...
    private void getBundleData() {
        ...
        if (intent != null && bundle != null) {
            ...
            question = bundle.getString("message");
            if (mapData != null && mapData.getData() != null) {
                ...
                if (!pop.isShow()) {
//                    pop.show();
                    new XPopup.Builder(UtryWalkingRouteSearchActivity.this)
...
//
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(UtryWalkingRouteSearchActivity.this);
            builder.setTitle("提示");
        ...
        if (result.getRouteLines() != null && result.getRouteLines().size() > 1) {
            mWalkingRouteResult = result;
            if (!hasShowDialog) {
                SelectRouteDialog selectRouteDialog = new SelectRouteDialog(UtryWalkingRouteSearchActivity.this,
        ...
        } else if (result.getRouteLines() != null && result.getRouteLines().size() == 1) {
            // 直接显示
...
//                mRouteOverlay = overlay;
    ...
    protected void onDestroy() {
        ...
        mBaiduMap.clear();
        mMapView.onDestroy();
        //  AIUIPlugin.Companion.getInstance().setUseChatBot(true);
    }
